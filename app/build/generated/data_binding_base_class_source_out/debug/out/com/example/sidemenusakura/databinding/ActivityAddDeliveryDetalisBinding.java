...
public final class ActivityAddDeliveryDetalisBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityAddDeliveryDetalisBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAddDeliveryDetalisBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_add_delivery_detalis, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAddDeliveryDetalisBinding bind(@NonNull View rootView) {
