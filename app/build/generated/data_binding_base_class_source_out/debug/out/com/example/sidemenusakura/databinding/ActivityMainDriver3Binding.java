...
public final class ActivityMainDriver3Binding implements ViewBinding {
  @NonNull
  ...
  private ActivityMainDriver3Binding(@NonNull ConstraintLayout rootView, @NonNull ImageButton add,
  ...
  @NonNull
  public static ActivityMainDriver3Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMainDriver3Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_main_driver3, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMainDriver3Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainDriver3Binding((ConstraintLayout) rootView, add, btnback, btndriver1,
