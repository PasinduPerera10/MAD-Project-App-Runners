...
public final class ActivityMainDriver4Binding implements ViewBinding {
  @NonNull
  ...
  private ActivityMainDriver4Binding(@NonNull ConstraintLayout rootView, @NonNull ImageButton add,
  ...
  @NonNull
  public static ActivityMainDriver4Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMainDriver4Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_main_driver4, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMainDriver4Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainDriver4Binding((ConstraintLayout) rootView, add, btnback, btndriver1,
