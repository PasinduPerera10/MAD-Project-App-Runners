...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull Button buttonLogin,
      ...
      @NonNull EditText editTextPassword, @NonNull TextView textView, @NonNull TextView textView11,
      @NonNull TextView textView12, @NonNull TextView textView2) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, buttonLogin, buttonRegister,
          editTextEmail, editTextPassword, textView, textView11, textView12, textView2);
    }
