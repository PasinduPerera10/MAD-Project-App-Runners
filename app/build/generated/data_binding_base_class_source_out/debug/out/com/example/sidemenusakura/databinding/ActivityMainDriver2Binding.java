...
public final class ActivityMainDriver2Binding implements ViewBinding {
  @NonNull
  ...
  private ActivityMainDriver2Binding(@NonNull ConstraintLayout rootView, @NonNull ImageButton add,
  ...
  @NonNull
  public static ActivityMainDriver2Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMainDriver2Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_main_driver2, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMainDriver2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainDriver2Binding((ConstraintLayout) rootView, add, btnback, btndriver1,
