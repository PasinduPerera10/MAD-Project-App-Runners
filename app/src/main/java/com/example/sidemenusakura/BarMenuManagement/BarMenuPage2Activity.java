...
public class BarMenuPage2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_barmenupage2);
        ...
        button31.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(BarMenuPage2Activity.this, BarMenuPage2Activity.class));
            }
        });
        ...
        button32.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(BarMenuPage2Activity.this, BarMenuPage3Activity.class));
            }
        });
        ...
        imageButtonhome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(BarMenuPage2Activity.this, MainActivity.class));
            }
        });
