...
public class LoginActivity extends AppCompatActivity {
    ...
    com.example.sidemenusakura.UserProfileManagement.DatabaseHelper db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new com.example.sidemenusakura.UserProfileManagement.DatabaseHelper(this);
        ...
        buttonRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(LoginActivity.this, com.example.sidemenusakura.UserProfileManagement.RegisterActivity.class));
            }
        });
        ...
        buttonLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (res == true) {
                    Intent HomePage = new Intent(LoginActivity.this, com.example.sidemenusakura.UserProfileManagement.UserProfileActivity.class);
                    Bundle b = new Bundle();
