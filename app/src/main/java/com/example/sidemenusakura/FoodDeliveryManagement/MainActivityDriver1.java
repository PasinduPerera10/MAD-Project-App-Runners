...
public class MainActivityDriver1 extends AppCompatActivity {
...
//    private Button add;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_driver1);
        context = this;
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(MainActivityDriver1.this, "Not Working", Toast.LENGTH_SHORT).show();
                }
            }
        });
